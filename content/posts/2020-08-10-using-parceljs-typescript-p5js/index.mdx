...
<!-- This is part one of a two part series. Read [Part 2](/using_vuejs_parceljs_p5js) -->

[p5.js](http://p5js.org/) is already great at being able to be used immedietely either with the [official editor](https://editor.p5js.org/) or loading it in via a 
...
```shell
yarn init -y #This just creates a package.json
...
<!-- You can also read [part 2 here](/using_vuejs_parceljs_p5js) -->